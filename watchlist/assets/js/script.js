window.onload = () => {
    ...
    var tv_series = ["How I Met Your Mother", "The Big Bang Theory", "Breaking Bad", "Stranger Things", "The Umbrella Academy", "BoJack Horseman", "The End of the F***ing World", "Sex Education", "La casa di carta", "Malcolm (Malcolm in the Middle)", "The Office", "Riverdale", "Mr. Robot", "Squid Game", "Atypical", "Alice in Borderland", "Strappare lungo i bordi", "Arcane", "Chernobyl", "Superstore", "Tredici"];
